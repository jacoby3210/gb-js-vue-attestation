...
export default createStore({
  state: {
    ...
    projects: [
      {id: 1,  name: "Современная Кухня",     category: "Декор / Планировка", image: "./resources/images/project-01.png", type:"Кухня"},
      {id: 2,  name: "Современная Ванная",    category: "Декор / Планировка", image: "./resources/images/project-02.png", type:"Ванная"},
      {id: 3,  name: "Современная Спальня",   category: "Декор / Планировка", image: "./resources/images/project-03.png", type:"Спальня"},
      {id: 4,  name: "Современная Гостиная",  category: "Декор / Планировка", image: "./resources/images/project-04.png", type:"Гостинная"},
      {id: 5,  name: "Современная Кухня",     category: "Декор / Планировка", image: "./resources/images/project-01.png", type:"Кухня"},
      {id: 6,  name: "Современная Ванная",    category: "Декор / Планировка", image: "./resources/images/project-02.png", type:"Ванная"},
      {id: 7,  name: "Современная Спальня",   category: "Декор / Планировка", image: "./resources/images/project-03.png", type:"Спальня"},
      {id: 8,  name: "Современная Гостиная",  category: "Декор / Планировка", image: "./resources/images/project-04.png", type:"Гостинная"},
      {id: 9,  name: "Современная Кухня",     category: "Декор / Планировка", image: "./resources/images/project-01.png", type:"Кухня"},
      {id: 10, name: "Современная Ванная",    category: "Декор / Планировка", image: "./resources/images/project-02.png", type:"Ванная"},
      {id: 11, name: "Современная Спальня",   category: "Декор / Планировка", image: "./resources/images/project-03.png", type:"Спальня"},
      {id: 12, name: "Современная Гостиная",  category: "Декор / Планировка", image: "./resources/images/project-04.png", type:"Гостинная"},
    ],
    statistics: [
